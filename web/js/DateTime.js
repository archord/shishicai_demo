...
CLASS_MSN_MESSAGE.prototype.show = function() {
    ...
    var str = "<div style=\" style='Z-INDEX: 99999; LEFT: 0px;WIDTH: " + w + "px; POSITION: relative; TOP: 0px; HEIGHT: " + h + "px; \"><div id=\"btSysClose\" style=\"position:absolute; z-index:99999; top:3px; right:3px; cursor:pointer;color:#000; background-color:#fff; float:right; width:16px; height:16px; font-weight:bold;\">×</div><div style=\"cursor:pointer;\" id=\"btCommand\"><img src=\"img/" + popoutImage + ".gif\" /></div></div>";
