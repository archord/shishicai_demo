        ...
        for (var i = 0; i < menus.length; i++) {
            ...
            switch (_linkMenu.getAttribute("pt")) {
                case "standard_star_1":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/StandardStar1_Normal.htm", Q: "竞猜开奖号码的最后一位，选择1个或多个号码投注，奖金<b style=\"color:#f00;\">10</b>元", YiLou: [1, 101, 102, 104, 106, 108] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                case "standard_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/StandardStar2_Normal.htm", Q: "竞猜开奖号码的最后两位，分别选择十位和个位的1个或多个号码投注，奖金<b style=\"color:#f00;\"/>100</b>元", YiLou: [1, 2, 201, 202, 204, 205, 206, 210, 211, 212, 213] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
                ...
                case "standard_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/StandardStar3_Normal.htm", Q: "竞猜开奖号码的后面三位，分别选择百位、十位和个位的1个或多个号码投注，奖金<b style=\"color:#f00;\"/>1000</b>元", YiLou: [1, 2, 3, 301, 302, 303, 305, 307, 309, 314, 315, 316, 318, 319, 320, 321] },
                ...
                case "standard_star_5":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/StandardStar5_Normal.htm", Q: "竞猜开奖号码的全部五位，分别选择每位的1个或多个号码投注，奖金<b style=\"color:#f00;\"/>100000</b>元", YiLou: [1, 2, 3, 4, 5, 201, 301, 601, 701, 801] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
                ...
                case "sum_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/SumStar2_Normal.htm", Q: "竞猜开奖号码最后两位的数字相加之和，选择1个或多个和值号码投注，奖金<b style=\"color:#f00;\"/>100</b>元", YiLou: [240, 241, 242, 243] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                case "sum_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/SumStar3_Normal.htm", Q: "竞猜开奖号码后面三位的数字相加之和，选择1个或多个和值号码投注，奖金<b style=\"color:#f00;\"/>1000</b>元", YiLou: [350, 351, 352, 353] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                ...
                case "dxds":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/DXDS_Normal.htm", Q: "竞猜开奖号码最后两位的大小单双，分别选择十位、个位投注，全部猜中则中奖，奖金<b style=\"color:#f00;\">4</b>元", YiLou: [10, 20, 291] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                ...
                case "zuxuan_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/ZuXuanStar2_Normal.htm", Q: "竞猜开奖号码的最后两位，选择2个或以上号码投注，奖金<b style=\"color:#f00;\">50</b>元<b style=\"color:#f00;\">(开出对子不算中奖)</b>", YiLou: [204, 205, 270, 272] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
                ...
                case "fenwei_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/FenWeiStar2_Normal.htm", Q: "竞猜开奖号码的最后两位，分别选择每位的个或以上号码投注，奖金<b style=\"color:#f00;\">50</b>元", YiLou: [1, 2, 202, 204, 205, 270] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                ...
                case "baodian_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/BaoDianStar2_Normal.htm", Q: "竞猜开奖号码后面两位的数字相加之和，开奖号码为对子奖金<b style=\"color:#f00;\"/>100</b>元;非对子奖金<b style=\"color:#f00;\"/>50</b>元", YiLou: [240, 241, 242, 243] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                case "baodan_star_2":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/BaoDanStar2_Normal.htm", Q: "竞猜开奖号码的后二位的胆码，任意一位开出即中奖，1个胆码包含10注；开奖号码为对子奖金<b style=\"color:#f00;\"/>100</b>元;非对子奖金<b style=\"color:#f00;\"/>50</b>元", YiLou: [202, 204, 205, 270, 271, 272] }
                    //                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                ...
                case "zuxuan3_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/ZuXuan3Star3_Normal.htm", Q: "竞猜开奖号码后三位，选择2个或以上号码投注，奖金<b style=\"color:#f00;\">320</b>元 <a style=\"font-size: 9pt;\" target=\"_blank\" href=\"/Help/Details.aspx?id=128\">什么是组选3？</a>", YiLou: [382, 318, 319, 320, 321, 370, 372, 378] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
                ...
                case "zuxuan6_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/ZuXuan6Star3_Normal.htm", Q: "竞猜开奖号码后三位，选择3个或以上号码投注，奖金<b style=\"color:#f00;\">160</b>元 <a style=\"font-size: 9pt;\" target=\"_blank\" href=\"/Help/Details.aspx?id=128\">什么是组选6？</a>", YiLou: [383, 318, 319, 320, 321, 370, 372] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
                ...
                case "baodian_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/BaoDianStar3_Normal.htm", Q: "竞猜开奖号码后面三位的数字相加之和，开奖号码为豹子形态奖金<b style=\"color:#f00;\"/>1000</b>元;组3形态奖金<b style=\"color:#f00;\"/>320</b>元;组6形态奖金<b style=\"color:#f00;\"/>160</b>元", YiLou: [350, 351, 352, 353] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                case "baodan_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/BaoDanStar3_Normal.htm", Q: "竞猜开奖号码的后三位的胆码，任意一位开出即中奖，1个胆码包含55注；开奖号码为豹子形态奖金<b style=\"color:#f00;\"/>1000</b>元;组三形态奖金<b style=\"color:#f00;\"/>320</b>元;组六形态奖金<b style=\"color:#f00;\"/>160</b>元", YiLou: [302, 382, 382, 318, 319, 320, 321, 370, 371, 372, 373, 378] }
                    //                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                    ];
                    break;
                case "zhixuanzuhe_star_3":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/ZhiXuanZuHeStar3_Normal.htm", Q: "竞猜开奖号码后三位，选择3个或以上号码投注，开奖号码为组六形态则中奖，奖金<b style=\"color:#f00;\">1000</b>元 <a style=\"font-size: 9pt;\" target=\"_blank\" href=\"/Help/Details.aspx?id=128\">什么是组选6？</a>", YiLou: [302, 382, 383, 320, 321, 370, 371, 372, 373, 318, 319] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" }
                ...
                case "tongxuan_star_5":
                    _linkMenu.childMenus = [
                        { Menu: "常规选号", Iframe: null, Src: "subpage/TongXuanStar5_Normal.htm", Q: "竞猜开奖号码的全部五位，全部猜中奖金<b style=\"color:#f00;\"/>20000</b>元；猜中前三或后三奖金<b style=\"color:#f00;\"/>200</b>元；猜中前二或后二奖金<b style=\"color:#f00;\"/>20</b>元", YiLou: [1, 2, 3, 4, 5, 201, 301, 601, 701, 801] },
                        { Menu: "走势选号", Iframe: null, Src: "TrendIframe.aspx?pl=" + _linkMenu.getAttribute("pt"), Q: "" },
        ...
        for (var i = 0; i < _ListRecord.length; i++) {
            ...
            if (_ListRecord[i].length == 0) {///当没有票数据时
                ...
                for (var j = 0; j < _ListRecord[i].length; j++) {
                    ...
                    html += "<li class=\"" + cssLi + " " + cssCurCase + "\" style=\"cursor:pointer;\" title=\"点击查看方案编号：" 
                        + tempObj.Digest + (tempObj.IPAddress == "0" ? "" : "(追号)") + "详情\"><a href=\"/UserCenter/ProjectDetail/Details.aspx?id="
                        + tempObj.ProjectId + "\" target=\"_blank\"><span class=\"i1\">" + _playType + "</span><span class=\"i2\">" + _anteCode
                        + "</span><span class=\"i3\">" + tempObj.Multiple + "</span><span class=\"i4\">" + tempObj.Money.toString().toMoney()
                        + "</span><span class=\"i5\">" + tempObj.IPAddress.split("_")[0] + "</span><span class=\"i6\">"
                        + (tempObj.BonusMoney > 0 ? tempObj.BonusMoney.toString().toMoney() : (tempObj.IPAddress == "已中奖_未返奖" ? "待派奖" : "-"))
                        + "</span><span class=\"i7\"><a title=\"点击撤销该票\" style=\"" + (tempObj.TicketStatus == "1" || tempObj.TicketStatus == "2" ? "display:none" : "display:none;")
                        + "\" href=\"javascript:void(0)\" _ticketId=\"" + tempObj.Id + "\" _projectNo=\"" + tempObj.Digest + "\" _projectId=\"" + tempObj.ProjectId + "\" _playType=\""
                        + _playType + "\" _anteCode=\"" + _anteCode + "\" onclick=\"GiveUpTicket(this);\">撤单</a></span></a></li>";
